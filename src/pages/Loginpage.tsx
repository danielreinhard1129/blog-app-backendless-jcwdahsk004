...
function Loginpage() {
  return (
    <div className="relative flex min-h-[calc(100vh-4rem)] items-center justify-center overflow-hidden bg-linear-to-b from-sky-50 to-white px-4 py-12">
      <div className="absolute inset-0 -z-10">
        <div className="absolute -top-20 left-1/2 h-72 w-160 -translate-x-1/2 rounded-full bg-sky-200/40 blur-3xl" />
        <div className="absolute bottom-0 right-0 h-64 w-96 rounded-full bg-sky-100/50 blur-3xl" />
      </div>
